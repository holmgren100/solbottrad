...
def load_config(env_file: str = '.env') -> BotConfig:
    ...
    partial_profit_settings = {
        ...
        'milestone_50': _get_float('PROFIT_MILESTONE_50', 20),   # 20% at 50%
        'milestone_100': _get_float('PROFIT_MILESTONE_100', 20),  # 20% at 100%
        'milestone_200': _get_float('PROFIT_MILESTONE_200', 15),  # 15% at 200%
